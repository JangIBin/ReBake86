...
<body>
	...
	<c:choose>
		...
		<c:when test="${loginID ne null }">
			<table width="300" border="1">
				...
				<tr>
					...
					<td width="100" align="center"><a
						href="/ReBake86/board/list.bdo">게시판</a></td>
					<td width="100" align="center"><a
						href="/ReBake86/board/mem/logout.bdo">로그아웃</a></td>
				</tr>
			</table>
		</c:when>
		...
		<c:otherwise>
			...
			<form action="/ReBake86/board/mem/loginProc.bdo" method="post">
				<table width="300" border="1">
					<tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="submit"
							value="로그인">&nbsp;&nbsp; <input type="button" value="게시판"
							onclick="javascript:window.location='/ReBake86/board/list.bdo'">
						</td>
					</tr>
				</table>
			</form>
