...
<ul>
      <img class="logoImg" src="image/logoImg.png" alt=""> 
        <li class="title">
          <a class="rebake" href="#">RE:<span>bake</span></a>
      ...
      <div class="mainImg">
        <div class="mainSentence">
          <p>Let's find <span>local bakerys</span> with us!</p>
        </div>
          <img class="mainSlides" src="image/main1.jpeg" alt="">
          <img class="mainSlides" src="image/main4.jpeg" alt="">
          <img class="mainSlides" src="image/main6.jpeg" alt="">
          <img class="mainSlides" src="image/main8.jpeg" alt="">
          
        <div class="clickhere"><a href="ChoosePage.html"></a> Click here</div>
      </div>
      <script>
      let slideIndex = 0;
